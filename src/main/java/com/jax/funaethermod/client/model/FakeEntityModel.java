...
public class FakeEntityModel<T extends Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(
                    new ResourceLocation(FunAetherMod.MODID, "fake_entity"),
                    "main"
            );
...
LAYER_LOCATION
--------------
Tells Minecraft which Blockbench model this Java class belongs to.

CONSTRUCTOR
-----------
Gets each body part from the baked model so we can animate and render it.

createBodyLayer()
-----------------
Recreates your Blockbench model in code.
Every addOrReplaceChild() is one body part.

setupAnim()
-----------
Runs every frame.

- Rotates the head toward where the entity is looking.
- Swings the arms and legs while walking.

renderToBuffer()
----------------
Actually draws every body part on the screen.

Whenever Minecraft renders the Fake Entity, it calls this method.
*/