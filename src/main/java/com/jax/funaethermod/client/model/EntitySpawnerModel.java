...
public class EntitySpawnerModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(
                    new ResourceLocation(FunAetherMod.MODID, "entity_spawner"),
                    "main"
            );
    ...
    public EntitySpawnerModel(ModelPart root) {
